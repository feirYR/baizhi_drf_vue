# Generated by Django 2.0.6 on 2020-07-22 15:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_vedio', models.FileField(blank=True, null=True, upload_to='vedio', verbose_name='课程视频')),
            ],
            options={
                'verbose_name': '专题课程',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='修改时间')),
                ('name', models.CharField(blank=True, max_length=32, null=True, verbose_name='优惠类型名称')),
                ('remark', models.CharField(blank=True, max_length=250, null=True, verbose_name='备注信息')),
            ],
            options={
                'verbose_name': '课程优惠类型',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lesson', models.IntegerField(default='第一个', verbose_name='第几个课时')),
